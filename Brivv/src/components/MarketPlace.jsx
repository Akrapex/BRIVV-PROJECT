    ...
    <section className="bg-[#f2f1e9] min-h-screen py-20 px-6 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <a
            href="#"
            className="text-[#6a8d24] font-bold underline decoration-2 underline-offset-4 hover:text-[#5a7a1f] transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {properties.map((property, index) => (
            <div
              key={index}
              className="bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300"
            >
              {/* Image Container */}
