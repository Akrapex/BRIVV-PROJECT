    ...
    <div className="w-full max-w-md space-y-6 h-full">
      <div className="space-y-2">
        ...
        <p className="text-sm text-neutral-500 leading-relaxed">
          Join the Akrapex network to start managing your digital property
          portfolio.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Field>
          <Button
            type="submit"
            className="w-full h-12 mt-2 bg-[#446000] text-white hover:bg-[#334800] rounded-md font-medium"
